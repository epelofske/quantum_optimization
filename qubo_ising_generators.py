...
def maximum_clique_ising_rigetti(G):
...
def maximum_independent_set_ising_rigetti(G):
...
def maximum_cut_ising_rigetti(G):
...
def vertex_cover_ising_rigetti(G):
	J = {}
	h = []
	for a in list(G.edges()):
		J[a] = 2
	...
	return h, J
def vertex_cover_qubo_rigetti(G):
...
def max_cut_qubo_matrix_ibmqx(G):
        ...
        for a in qubo:
                ...
                data[a[1], a[0]] = qubo[a]
        return data
def max_cut_ising_matrix_ibmqx(G):
        h, J = maximum_cut_ising_rigetti(G)
        data = np.zeros((len(G), len(G)))
        for a in J:
                data[a[0], a[1]] = J[a]
                data[a[1], a[0]] = J[a]
...
def min_vertex_cover_qubo_matrix_ibmqx(G):
...
def max_independent_set_qubo_matrix_ibmqx(G):
        ...
        for a in qubo:
                ...
                data[a[1], a[0]] = qubo[a]
        return data
def max_independent_set_ising_matrix_ibmqx(G):
...
def max_clique_qubo_matrix_ibmqx(G):
        ...
        for a in qubo:
                ...
                data[a[1], a[0]] = qubo[a]
        return data
def max_clique_ising_matrix_ibmqx(G):
